...
- Food
    - Food events in [Pittsburgh Annual Events](https://www.visitpittsburgh.com/events-festivals/annual-events/). Navigate to the *details* page for each.
    - [Food Festival](https://www.visitpittsburgh.com/events-festivals/food-festivals/)
    - Event-specific websites: [PicklesBurgh](https://www.picklesburgh.com), [Pittsburgh Taco Festival](https://www.pghtacofest.com), [Pittsburgh restaurant week](https://pittsburghrestaurantweek.com),[Little Italy Days](https://littleitalydays.com), [Banala split celebration](https://bananasplitfest.com)
        - For these event-specific sources, you can also be asked questions on the contents found in the navigation bar.
